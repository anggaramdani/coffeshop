...
import com.relife.coffeshops.databinding.FragmentOrderBinding;
...
//        return inflater.inflate(R.layout.fragment_order, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        fragmentOrderBinding.ShopButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                shopViewModel.resetCart();
                navController.navigate(R.id.action_orderFragment_to_coffeFragment);
            }
        });
